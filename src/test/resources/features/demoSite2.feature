#language: es
  Característica: Registrar usuario en Demo Site version 2

  @smoke
  Esquema del escenario: : Registrar usuario version 2
    ...
    @regresion
    Escenario: Registrar solo informacion del contacto version 2
      Dado que la web esta operativa
      Y ingresar a la opcion de registrar
